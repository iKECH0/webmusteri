  ...
  return (
    <div style={{ background: BG, color: '#f0ebf5', fontFamily: '"Inter", system-ui, sans-serif', overflowX: 'hidden' }}>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          .salon-hero-grid, .salon-whyus-grid { grid-template-columns: 1fr !important; gap: 40px !important; }
          .salon-stats-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
      `}</style>
      ...
      <section style={{ position: 'relative', minHeight: '90vh', display: 'flex', alignItems: 'center', padding: '80px 32px', overflow: 'hidden' }}>
        ...
        <div className="salon-hero-grid" style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', width: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
          <div>
            ...
            {address && <div style={{ marginTop: 28, display: 'flex', alignItems: 'center', gap: 8, color: '#94a3b8', fontSize: 13, animation: 'heroFadeUp .7s .4s ease both' }}><MapPin size={14} />{address}</div>}
          </div>
          ...
          <div style={{ animation: 'heroFadeUp .9s .2s ease both' }}>
            <div style={{ background: CARD, border: '1px solid rgba(255,255,255,.08)', borderRadius: 24, overflow: 'hidden', boxShadow: '0 40px 80px rgba(0,0,0,.5)' }}>
              <div style={{ padding: '16px 20px', borderBottom: '1px solid rgba(255,255,255,.05)', display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ marginLeft: 8, fontSize: 12, color: '#94a3b8' }}>{businessName} · Premium Güzellik Merkezi</span>
              </div>
      ...
      <div ref={statsRef} style={{ borderTop: '1px solid rgba(255,255,255,.05)', borderBottom: '1px solid rgba(255,255,255,.05)' }}>
        <div className="salon-stats-grid" style={{ maxWidth: 900, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)' }}>
      ...
      <section id="why" style={{ padding: '96px 32px', background: 'rgba(255,255,255,.012)', borderTop: '1px solid rgba(255,255,255,.04)', borderBottom: '1px solid rgba(255,255,255,.04)' }} ref={whyRef}>
        <div className="salon-whyus-grid" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: '#94a3b8', lineHeight: 1.75, marginBottom: 36 }}>{businessName} olarak her müşterimize özel zaman ve özen ayırıyoruz. Randevusuz bekleme yok, koşturmaca yok.</p>
      ...
      <section style={{ padding: '96px 32px', borderTop: '1px solid rgba(255,255,255,.05)' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 16, color: '#94a3b8', lineHeight: 1.7, marginBottom: 40 }}>Whatsapp'tan yazın, size en uygun randevu zamanını ayarlayalım.</p>
